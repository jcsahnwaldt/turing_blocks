...
static void init_action(action_t* a, const char* n, state_t* cs, state_t* ns, value_t* v, step_t* t, long* c) {
  a->name = n;
  a->counter = c;
  a->max = -1;
...
void init_goto(action_t* a, const char* n, state_t* cs, state_t* ns, value_t* v, step_t* t, long* c) {
  init_action(a, n, cs, ns, v, t, c);
  a->do_cell = do_cell_goto;
  a->do_next = do_next_goto;
}

void init_halt(action_t* a, const char* n, state_t* s, value_t* v, step_t* t, long* c) {
  init_action(a, n, s, s, v, t, c);
